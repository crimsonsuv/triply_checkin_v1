                                                      ...
                                                      child: Container(
                                                        ...
                                                        child: Column(
                                                          children: <Widget>[
                                                            ...
                                                            Text(
                                                              (snapshot.data?.customFields.length > 3) ?'${snapshot.data?.customFields[3][1]}':'no entry',
                                                              style: textStyle(
                                                                  Colors.black26,
                                                                  FontWeight.w400,
                                                                  15),
...
//                  ),
  ...
  void _onQRViewCreated(QRViewController controller) {
    try{
      ...
      channel.setMethodCallHandler((MethodCall call) async {
        switch (call.method) {
          case "onRecognizeQR":
            ...
            if (!isSheetShown.value && qrCode.value != arguments.toString()) {
              qrCode.add(arguments.toString());
              _showModal(context);
              isSheetShown.add(true);
            }
            break;
      ...
      }); //Or whatever part of code that crashes
    }
    catch(Exception){
    print("joshtag THIS PHONE DOES NOT SUPPORT AUTOFOCUS!!"); //a warning, popup, whatever
    }
  }
}
